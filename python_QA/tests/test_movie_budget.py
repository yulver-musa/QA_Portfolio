...
def test_mb_94_business_logic_unsuccessful():
    # Arrange
    budget = 1000
    crew_members = 100
    costume_price = 100
    director_name = "Gerard Butler"
    movie_name = "13"
    # Act
    valid, message, difference = calculate_movie_budget(
        budget, crew_members, costume_price, director_name, movie_name
...
def test_mb_96_business_logic_unsuccessful():
    # Arrange
    budget = 1000
...
def test_mb_97_business_logic_unsuccessful():
    # Arrange
    budget = 1000
    crew_members = 1000
    costume_price = 100
...
def test_mb_100_business_logic_unsuccessful():
    # Arrange
    budget = -1000
    crew_members = 0
    costume_price = 0
